...
public class AnnuaireImpl implements annuaireOperations {
   ...
   * @throws controleAcces.sessionInvalidException la clé de session n'existe
   * pas
   ...
   * incomplet). Calcul automatique et renvoi du nouveau matricule et du nouveau
   * mot de passe dans un objet personneIdl complet.
   *
   * @param cle la clé de session autorisant le traitement
   ...
   * fournir les nom, prénom, et photo dans un objet personneIdl (donc
   * incomplet). Calcul automatique et renvoi du nouveau matricule dans un objet
   * personneIdl complet.
   *
   * @param cle la clé de session autorisant le traitement
   * @param p
