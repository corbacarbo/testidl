...
public class AnneeHelper
{
    ...
    private final static String _id = "IDL:controleAcces/Annee:1.0";

    /**
     * Read Annee from a marshalled stream
    ...
    /**
     * Write Annee into a marshalled stream
