        ...
        implements annuaireOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_authentification(
        ...
        try
        {
            controleAcces.cle _arg_result = authentification(arg0_in, arg1_in);

            _output = handler.createReply();
            controleAcces.cleStructHelper.write(_output,_arg_result);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_rechercherPersonne(
        ...
        try
        {
            controleAcces.personne[] _arg_result = rechercherPersonne(arg0_in, arg1_in, arg2_in);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_validerIdentite(
        ...
        try
        {
            controleAcces.personne _arg_result = validerIdentite(arg0_in);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_ajouterPermanent(
            ...
            final org.omg.CORBA.portable.ResponseHandler handler) {
        org.omg.CORBA.portable.OutputStream _output;
        controleAcces.personne arg0_in = controleAcces.personneStructHelper.read(_is);

        controleAcces.personne _arg_result = ajouterPermanent(arg0_in);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_ajouterTemporaire(
        ...
        controleAcces.personne _arg_result = ajouterTemporaire(arg0_in);
