...
/** 
 * Helper class for : demandeIdl
 *  
 * @author OpenORB Compiler
 */ 
public class demandeIdlHelper
{
    ...
    /**
     * Insert demandeIdl into an any
     * @param a an any
     * @param t demandeIdl value
     */
    ...
    /**
     * Extract demandeIdl from an any
     * @param a an any
     * @return the extracted demandeIdl value
     */
    ...
    private final static String _id = "IDL:controleAcces/journal/demandeIdl:1.0";

    /**
     * Read demandeIdl from a marshalled stream
     * @param istream the input stream
     * @return the readed demandeIdl value
     */
