...
/** 
 * Helper class for : personneIdl
 *  
 * @author OpenORB Compiler
 */ 
public class personneIdlHelper
{
    ...
    /**
     * Insert personneIdl into an any
     * @param a an any
     * @param t personneIdl value
     */
    ...
    /**
     * Extract personneIdl from an any
     * @param a an any
     * @return the extracted personneIdl value
     */
    ...
    private final static String _id = "IDL:controleAcces/personneIdl:1.0";

    /**
     * Read personneIdl from a marshalled stream
     * @param istream the input stream
     * @return the readed personneIdl value
     */
    public static controleAcces.personneIdl read(org.omg.CORBA.portable.InputStream istream)
    {
        controleAcces.personneIdl new_one = new controleAcces.personneIdl();
