...
public class personneStructHelper
{
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            ...
            _tc = orb.create_alias_tc(id(),"personneStruct",controleAcces.personneHelper.type());
                _working = false;
            }
        }
        return _tc;
    ...
    {
        return controleAcces.personneHelper.read(istream);
    }
    ...
    {
        controleAcces.personneHelper.write(ostream, value);
    }
